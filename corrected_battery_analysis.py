# Corrected analysis for finding vehicle with highest battery capacity
# This uses the proper DataFrame references that work in the RAG application

# Check battery-related columns in df1
battery_columns = [col for col in df1.columns if 'Battery' in col]
print("Battery-related columns:", battery_columns)

# Since we don't have direct charge time data, let's analyze battery capacity
